<?PHP
	class S3
	{
		...
		function putObject($bucket, $object, $filename, $public = null, $disposition = null, $headers = null)
		{
			...
			if(is_null($disposition))
				$disposition = array_pop(explode('/', $object));
		...
		function objectIsSame($bucket, $object, $hash)
		{
			$info = $this->getObjectInfo($bucket, $object);
